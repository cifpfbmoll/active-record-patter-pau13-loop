package edu.pingpong.activerecord.pattern.service;
...
import edu.pingpong.activerecord.pattern.domain.Comments;
import edu.pingpong.activerecord.pattern.repository.RepoComments;
